  ...
  return (
    <main className="min-h-screen bg-slate-50 bg-[#070a11] text-slate-900">
      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        ...
        {message && (
          <div className="mb-6 flex items-center justify-between rounded-xl border border-blue-100 bg-blue-50 px-4 py-3 text-sm text-blue-700 shadow-sm">
            <span>{message}</span>
          ...
          {importedService && (
            <div className="mt-4 rounded-xl border border-gray-200 bg-gray-50 p-4">
              ...
              <div className="mt-4 grid grid-cols-2 gap-2 sm:grid-cols-4">
                ...
                <div className="rounded-lg bg-gray-100 p-3">
                <p className="text-[10px] text-slate-500">Average Time</p>
                <p className="mt-1 text-sm font-semibold text-blue-700">
                  {vipsmmService?.averageTime || "N/A"}
                </p>
              </div>
              <div className="rounded-lg bg-gray-100 p-3">
                  <p className="text-[10px] text-slate-500">Limits</p>
                  <p className="mt-1 text-sm font-semibold text-gray-900">
        ...
        <section className="mb-6 rounded-2xl border border-blue-100 bg-blue-50/70 p-5 shadow-sm">
          <div className="mb-3">
            <h3 className="text-lg font-semibold">
              Import from MKAPI
            </h3>
      ...
      <div className="mt-2 flex gap-2">
        ...
        >
          Create
              ...
              <div className="grid grid-cols-2 gap-3">
                <label className="flex cursor-pointer items-center gap-3 rounded-xl border border-gray-200 bg-white p-3 shadow-sm">
                  <input
                    type="checkbox"
