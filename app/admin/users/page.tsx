...
export default function AdminUsersPage() {
  ...
  async function updateDiscount(
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          data.error || "Could not update discount."
        );
      }
                    ...
                    <div className="min-w-[150px]">
                      ...
                      <div className="mt-1 flex items-center gap-2">
                        <input
                          ...
                          max="100"
                          step="0.01"
                          defaultValue={user.discountPercent}
                          onChange={(e) => {
                          ...
                          className="w-20 rounded-lg border border-white/10 bg-white/[0.04] px-2.5 py-2 text-sm text-white outline-none focus:border-blue-500/50"
                        />
