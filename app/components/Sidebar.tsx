    ...
    <aside className="fixed left-0 top-0 z-40 hidden h-screen w-[250px] border-r border-white/[0.07] bg-[#080b12] lg:block">
      <div className="flex h-full flex-col">
        ...
        <div className="border-t border-white/[0.07] p-4">
          <div className="rounded-2xl border border-[#635bff]/10 bg-[#635bff]/5 p-4">
            ...
            <Link
              href="/funds"
              className="mt-3 flex h-9 items-center justify-center rounded-lg bg-[#635bff] text-xs font-semibold text-white hover:bg-[#7169ff]"
            >
              Add Funds
            </Link>
          </div>
